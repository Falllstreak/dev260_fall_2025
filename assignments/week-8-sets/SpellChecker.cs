...
namespace Assignment8
{
    ...
    public class SpellChecker
    {
        ...
        public bool LoadDictionary(string filename)
        {
            ...
            {
                // If anything unexpectedly blows up (permissions, IO, etc.)
                return false;
            }
        }
        ...
        public (bool inDictionary, bool inText, int occurrences) CheckWord(string word)
        {
            ...
            bool inTxt = uniqueWordsInText.Contains(normalizedWord);
            int count = allWordsInText.Count(w => w.Equals(normalizedWord, StringComparison.OrdinalIgnoreCase));
        ...
        public List<string> GetMisspelledWords(int maxResults = 50)
        {
            ...
            return misspelledWords.OrderBy(word => word).Take(maxResults).ToList();
        }
        ...
        public List<string> GetUniqueWordsSample(int maxResults = 20)
        {
            ...
            return uniqueWordsInText.OrderBy(word => word).Take(maxResults).ToList();
        }
